...
target "default" {
    ...
    labels = {
        ...
        "org.opencontainers.image.description" = "Claude Code running `claude remote-control` as an always-on server, with mise bootstrapping only the Node runtime it needs"
